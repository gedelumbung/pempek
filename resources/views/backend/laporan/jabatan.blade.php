...
@section("content")
<a href="{{route('dashboard.laporan.jabatan.cetak', ['type' => 'excel'])}}" class="btn btn-danger">Export to Excel</a>
<a href="{{route('dashboard.laporan.jabatan.cetak', ['type' => 'print'])}}" class="btn btn-danger">Print</a>
