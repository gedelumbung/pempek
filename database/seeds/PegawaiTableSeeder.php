    ...
    "tingkatpddk_id": "1"
        ...
        foreach ($params as $key=>$param) {
            $pegawai = Pegawai::create([
              ...
              'tanggal_lahir' => date('d/m/Y', strtotime($param->tgl_lahir)),
              ...
              'tmt_cpns' => date('d/m/Y', strtotime($param->tmtcpns)),
              'tmt_pns' => date('d/m/Y', strtotime($param->tmtpns)),
              ...
              'foto' => "",
              'unit_organisasi' => "Kementrian Desa, Pembanguanan Daerah Tertinggal dan Transmigrasi",
              ...
              'satuan_kerja_id' => 1,
              'eselon' => $param->eselon,
              'tmt_eselon' => date('d/m/Y', strtotime($param->tmteselon)),
              'golongan_id_awal' => str_replace(" ", "", str_replace("k", "", $param->golruangawal)),
              'tmt_golongan_awal' => date('d/m/Y', strtotime($param->tmtgolawal)),
              'golongan_id_akhir' => str_replace(" ", "", str_replace("k", "", $param->golruangakhir)),
              'tmt_golongan_akhir' => date('d/m/Y', strtotime($param->tmtgolakhir)),
              ...
              'tahun_no_akte_kelahiran' => substr($param->tanggalakte, 0,4),
              'no_askes' => $param->noaskes,
              'no_taspen' => $param->notaspen,
              'no_npwp' => $param->nonpwp,
              'tanggal_npwp' => date('d/m/Y', strtotime($param->tanggalnpwp)),
              'golongan_darah' => ""
            ]);
