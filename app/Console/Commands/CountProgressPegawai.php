...
class CountProgressPegawai extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'simpeg:pegawai:count_progress';
    ...
    public function handle()
    {
        ...
        foreach ($pegawai as $key => $data) {
            ...
            FROM pegawai where id = '".$data->id."'");
            $data->count_progress = $count[0]->count_progress;
            $data->save();
        }
    }
}
