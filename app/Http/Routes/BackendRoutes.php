...
class BackendRoutes implements RoutesInterface
{
    ...
    public function laporan()
    {
        ...
        $this->router->get('/laporan-nominatif/cetak/{type}', ['as' => 'dashboard.laporan.nominatif.cetak', 'uses' => 'LaporanNominatifController@prints']);
        ...
        $this->router->get('/laporan-golongan/cetak/{type}', ['as' => 'dashboard.laporan.golongan.cetak', 'uses' => 'LaporanGolonganController@prints']);

        $this->router->get('/laporan-usia', ['as' => 'dashboard.laporan.usia', 'uses' => 'LaporanUsiaController@index']);
        $this->router->get('/laporan-usia/cetak/{type}', ['as' => 'dashboard.laporan.usia.cetak', 'uses' => 'LaporanUsiaController@prints']);
        
        $this->router->get('/laporan-jenis-kelamin', ['as' => 'dashboard.laporan.jenis_kelamin', 'uses' => 'LaporanJenisKelaminController@index']);
        $this->router->get('/laporan-jenis-kelamin/cetak/{type}', ['as' => 'dashboard.laporan.jenis_kelamin.cetak', 'uses' => 'LaporanJenisKelaminController@prints']);
